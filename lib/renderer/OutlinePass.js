...
// This is mostly a copy of the Three.js OutlinePass. It has been modified to avoid using additive
// blending, which was causing a flickering issue.
...
class OutlinePass extends Pass {
	...
	render( renderer, writeBuffer, readBuffer, deltaTime, maskActive ) {
		...
		if ( this.selectedObjects.length > 0 ) {
			...
			this.overlayMaterial.uniforms[ 'tDiffuse' ].value = readBuffer.texture;
	...
	getOverlayMaterial() {
        ...
        uniform sampler2D tDiffuse;
          ...
          gl_FragColor = vec4(mix(scene.rgb, finalColor.rgb, finalColor.a), 1.0);
				}`,
			depthTest: false,
			depthWrite: false,
		} );
