...
class Gui {
  constructor(canvas, dataState, commands) {
    ...
    this.projectInput = {
      ...
      newProjectName: '',
      importUrl: 'https://raw.githubusercontent.com/KhronosGroup/glTF-Sample-Models/master/2.0/Box/glTF-Embedded/Box.gltf',
    };
  ...
  drawProjectDialog() {
    ...
    //Draw.Text('', this.projectInput, 'importUrl');
    if (ImGui.Button('Import')) {
      this.commands.importUrl(this.projectInput.importUrl);
    }
