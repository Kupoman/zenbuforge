...
class Gui {
  ...
  update(dt, projectData, updates) {
    ...
    jsonpatch.applyPatch(this.projectSession, updates.projectSession, true, true, true);
    jsonpatch.applyPatch(this.clientSession, updates.clientSession, true, true, true);
    jsonpatch.applyPatch(this.userSession, updates.userSession, true, true, true);

    const model = {
      project: projectData,
      session: this.projectSession,
    };
    const { width, height } = this.clientSession;
